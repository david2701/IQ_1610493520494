    ...
    const sideList = (
      <div className={classes.list}>
        <div className="navbar-drawer-header">
          ...
          <div className="navbar-drawer-text">IQ</div>
        </div>
        <Divider />
        <List>
          {/* START LINK MENU */}
           ...
           <Link to="/leagues">
            <ListItem button key="League">
              ...
              <ListItemText className="menu-text" primary="League" />
            </ListItem>
          </Link>{" "}            
           <Link to="/matcheses">
            <ListItem button key="Matches">
              ...
              <ListItemText className="menu-text" primary="Matches" />
            </ListItem>
          </Link>{" "}            
           <Link to="/playerses">
            <ListItem button key="Players">
              ...
              <ListItemText className="menu-text" primary="Players" />
            </ListItem>
          </Link>{" "}            
           <Link to="/preferenceses">
            <ListItem button key="Preferences">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="Preferences" />
            </ListItem>
          </Link>{" "}            
           <Link to="/teamses">
            <ListItem button key="Teams">
              ...
              <ListItemText className="menu-text" primary="Teams" />
            </ListItem>
          </Link>{" "} {/* END LINK MENU */}
        </List>
      </div>
